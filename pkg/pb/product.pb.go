...
var file_proto_product_proto_depIdxs = []int32{
	0, // 0: products.ProductService.CreateProduct:input_type -> products.CreateProductRequest
	1, // 1: products.ProductService.CreateProduct:output_type -> products.CreateProductResponse
